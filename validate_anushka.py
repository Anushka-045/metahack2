...
validate_anushka.py
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Pre-submission validation for Anushka's component.
...
def check_app_py():
    with open("app.py") as f:
        src = f.read()
    required = ["from anushka_server import app", "uvicorn.run", "7860"]
...
def check_requirements():
    with open("requirements_anushka.txt") as f:
        src = f.read()
...
check("requirements_anushka.txt", check_requirements)
...
def check_server_import():
    ...
    spec = importlib.util.spec_from_file_location("anushka_server", "anushka_server.py")
...
if passed == total:
    ...
    print("Next step:")
    print("  git add .")
    print("  git commit -m 'feat: Anushka compliance pipeline complete'")
