...
merge_bridge.py
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
THE SINGLE MERGE POINT BETWEEN ANUSHKA AND GARGI.

Gargi imports this module inside ComplianceEnvironment.reset() to swap out
dummy data for Anushka's real database + extracted rules.
...
The bridge is fully backward-compatible:
  - If Anushka's server is unreachable, MERGE_AVAILABLE = False and Gargi's
...
try:
    ...
    if MERGE_AVAILABLE:
        logger.info(f"[merge_bridge] Anushka pipeline reachable at {PIPELINE_URL}")
    else:
...
def load_real_data(task_id: str = "task_easy") -> Tuple[List[Dict], List[Dict]]:
    """
    Fetch records and rules from Anushka's pipeline in the format
...
def get_pipeline_summary() -> Dict[str, Any]:
    """Return Anushka's compliance summary (for display in Gargi's /state)."""
    import requests
